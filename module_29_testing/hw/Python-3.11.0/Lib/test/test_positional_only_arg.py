...
class PositionalOnlyTestCase(unittest.TestCase):
    ...
    def test_optional_positional_only_args(self):
        ...
        with self.assertRaisesRegex(
            TypeError,
            r"f\(\) got some positional-only arguments passed as keyword arguments: 'b'",
        ):
            f(1, b=2, c=3)
    ...
    def test_use_positional_as_keyword(self):
        ...
        expected = (
            r"f\(\) got some positional-only arguments passed as keyword arguments: 'a'"
        )
    ...
    def test_positional_only_and_arg_invalid_calls(self):
        ...
        with self.assertRaisesRegex(
            TypeError, r"f\(\) missing 1 required positional argument: 'c'"
        ):
            f(1, 2)
        with self.assertRaisesRegex(
            TypeError, r"f\(\) missing 2 required positional arguments: 'b' and 'c'"
        ):
            f(1)
        with self.assertRaisesRegex(
            TypeError,
            ...
            f()
        with self.assertRaisesRegex(
            TypeError, r"f\(\) takes 3 positional arguments but 4 were given"
        ):
            f(1, 2, 3, 4)
    ...
    def test_positional_only_and_optional_arg_invalid_calls(self):
        ...
        with self.assertRaisesRegex(
            TypeError, r"f\(\) missing 1 required positional argument: 'b'"
        ):
            f(1)
        with self.assertRaisesRegex(
            TypeError, r"f\(\) missing 2 required positional arguments: 'a' and 'b'"
        ):
            f()
        with self.assertRaisesRegex(
            TypeError, r"f\(\) takes from 2 to 3 positional arguments but 4 were given"
        ):
            f(1, 2, 3, 4)
    ...
    def test_positional_only_and_kwonlyargs_invalid_calls(self):
        ...
        with self.assertRaisesRegex(
            TypeError, r"missing 1 required keyword-only argument: 'd'"
        ):
            f(1, 2, 3, e=2)
        with self.assertRaisesRegex(
            TypeError, r"missing 2 required keyword-only arguments: 'd' and 'e'"
        ):
            f(1, 2, 3)
        with self.assertRaisesRegex(
            TypeError, r"f\(\) missing 1 required positional argument: 'c'"
        ...
        with self.assertRaisesRegex(
            ...
            f(1)
        with self.assertRaisesRegex(
            TypeError, r" missing 3 required positional arguments: 'a', 'b', and 'c'"
        ):
            f()
        with self.assertRaisesRegex(
            TypeError,
            r"f\(\) takes 3 positional arguments but 6 positional arguments "
            r"\(and 2 keyword-only arguments\) were given",
        ):
            f(1, 2, 3, 4, 5, 6, d=7, e=8)
        with self.assertRaisesRegex(
            TypeError, r"f\(\) got an unexpected keyword argument 'f'"
        ):
    ...
    def test_positional_only_invalid_calls(self):
        ...
        with self.assertRaisesRegex(
            ...
            f()
        with self.assertRaisesRegex(
            TypeError, r"f\(\) takes 2 positional arguments but 3 were given"
        ):
            f(1, 2, 3)
    ...
    def test_positional_only_with_optional_invalid_calls(self):
        ...
        f(1)  # does not raise
        with self.assertRaisesRegex(
            TypeError, r"f\(\) missing 1 required positional argument: 'a'"
        ):
            f()

        with self.assertRaisesRegex(
            TypeError, r"f\(\) takes from 1 to 2 positional arguments but 3 were given"
        ):
            f(1, 2, 3)
    ...
    def test_closures(self):
        ...
        with self.assertRaisesRegex(
            TypeError, r"g\(\) missing 1 required positional argument: 'y2'"
        ):
            f(1, 2)(3)
        with self.assertRaisesRegex(
            TypeError, r"g\(\) takes 2 positional arguments but 3 were given"
        ):
            f(1, 2)(3, 4, 5)
    ...
    def test_same_keyword_as_positional_with_kwargs(self):
        ...
        with self.assertRaisesRegex(
            TypeError, r"f\(\) missing 1 required positional argument: 'something'"
        ):
            f(something=42)
    ...
    def test_serialization(self):
        ...
        expected = (
            r"global_pos_only_f\(\) got some positional-only arguments "
        ...
        expected = (
            r"global_pos_only_and_normal\(\) got some positional-only arguments "
        ...
        expected = (
            r"global_pos_only_defaults\(\) got some positional-only arguments "
            r"passed as keyword arguments: 'a'"
        )
        with self.assertRaisesRegex(TypeError, expected):
