...
class BaseTest(unittest.TestCase):
    ...
    def test_repr(self):
        ...
        x1 = tuple[tuple(tuple[int])]  # Effectively the same as starring; TODO
        self.assertEqual(repr(x1), "tuple[*tuple[int]]")
        x2 = tuple[tuple(tuple[int, str])]  # Ditto TODO
        self.assertEqual(repr(x2), "tuple[*tuple[int, str]]")
        x3 = tuple[tuple(tuple[int, ...])]  # Ditto TODO
    ...
    def test_parameters(self):
        ...
        T1 = tuple[tuple(tuple[int])]  # Ditto TODO
        self.assertEqual(T1.__args__, tuple(tuple[int]))  # Ditto TODO
        self.assertEqual(T1.__parameters__, ())

        T2 = tuple[tuple(tuple[T])]  # Ditto TODO
        self.assertEqual(T2.__args__, tuple(tuple[T]))  # Ditto TODO
        self.assertEqual(T2.__parameters__, (T,))

        T4 = tuple[tuple(tuple[int, str])]  # Ditto TODO
        self.assertEqual(T4.__args__, tuple(tuple[int, str]))  # Ditto TODO
    ...
    def test_equality(self):
        ...
        self.assertEqual(
            tuple[tuple(tuple[int])],  # Effectively the same as starring; TODO
            tuple[tuple(tuple[int])],  # Ditto TODO
        )
